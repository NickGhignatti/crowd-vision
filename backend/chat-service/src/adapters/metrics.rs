...
pub static HTTP_REQUESTS_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec_with_registry!(
        ...
        "Total number of chat-service HTTP requests",
        LABELS,
        REGISTRY
    )
...
pub static HTTP_REQUESTS_ERROR: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec_with_registry!(
        ...
        "Total number of chat-service HTTP requests that failed with a server (5xx) error",
        LABELS,
        REGISTRY
    )
    .expect("metric can be created")
...
pub static HTTP_REQUEST_DURATION: LazyLock<HistogramVec> = LazyLock::new(|| {
    register_histogram_vec_with_registry!(
        ...
        "Duration of chat-service HTTP requests in seconds",
        LABELS,
