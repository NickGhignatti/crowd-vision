"""Runs digital-twin's building payload through the projections the twin tools hand
to the model. The fixture is the same file digital-twin asserts against
(digital-twin/tests/building_conformance.rs), so a renamed or dropped field fails on
...
_FIXTURE = Path(__file__).resolve().parents[4] / "schemas" / "fixtures" / "building.json"
