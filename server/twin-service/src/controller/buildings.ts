...
export const getBuildingByDomain = async (req: Request, res: Response) => {
    ...
    const buildings = await BuildingService.getBuildingsByDomain(domain as string);
...
export const updateRoom = async (req: Request, res: Response) => {
    ...
    const updatedRoom = await BuildingService.updateRoom(buildingId as string, roomId as string, updates);
...
export const updateBuilding = async (req: Request, res: Response) => {
    ...
    const updates = req.body;
    const updatedBuilding = await BuildingService.updateBuilding(buildingId as string, updates);
...
export const getDomainsByBuilding = async (req: Request, res: Response) => {
  ...
  res.status(200).json(await BuildingService.getDomainsByBuilding(buildingName));
}