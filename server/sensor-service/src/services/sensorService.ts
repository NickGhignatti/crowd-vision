...
export const postPeopleCountSignal = async (
  building: string,
  roomId: string,
  timestamp: number,
  peopleCount: number,
...
export const postTemperatureSignal = async (
  building: string,
  roomId: string,
  timestamp: number,
  temperature: number,
...
export const postAirQualitySignal = async (
  ...
  await AirQuality.create(
    scenario === undefined ? payload : { ...payload, scenario },
  );
};

export const getLatestsPeopleCountSignal = async (
  building: string,
  roomId: string,
) => {
...
export const getLatestsTemperatureSignal = async (
  building: string,
  roomId: string,
) => {
...
export const getLatestsAirQualitySignal = async (
  building: string,
  roomId: string,
) => {
