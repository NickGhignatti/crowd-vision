...
describe('QrCodeCard', () => {
  ...
  describe('rendering states', () => {
    ...
    it('renders translated text for title and scan message', async () => {
      ...
      await flushPromises() // Wait for watch to process QrCodeCard generation
  ...
  describe('QrCodeCard code logic', () => {
    it('generates QrCodeCard codes for all provided roles on mount', async () => {
      const wrapper = createWrapper()
  ...
  describe('watchers', () => {
    it('resets state when domain changes', async () => {
      ...
      // The watcher should reset `selectedRole` to null, removing the QrCodeCard view
