...
<template>
  <div class="min-h-screen bg-slate-50 selection:bg-emerald-100 selection:text-emerald-900">
    ...
    <section class="relative pt-20 pb-32 overflow-hidden">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div class="mt-10 flex justify-center gap-4">
          <a class="px-8 py-3.5 rounded-xl bg-white text-slate-700 font-bold border border-slate-200 hover:border-slate-300 shadow-sm transition-all hover:bg-slate-50"
    ...
    <section id="features" class="py-24 bg-white border-y border-slate-200 relative overflow-hidden">
      <div class="absolute inset-0 w-full h-full z-0 pointer-events-none opacity-15 select-none" style="
          mask-image: linear-gradient(to bottom, black 50%, transparent 100%);
          -webkit-mask-image: linear-gradient(to bottom, black 50%, transparent 100%);
        ">
        <img src="@/assets/background.png" alt="3D Building Blueprint"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="relative w-full max-w-5xl mx-auto h-[350px] md:h-[400px] flex justify-center items-center"
          @mouseenter="stopAutoplay" @mouseleave="startAutoplay">
          <div v-for="(feature, index) in features" :key="feature.id" @click="goToFeature(index)"
