...
describe('RoomsSelector', () => {
  ...
  describe('rendering and layout', () => {
    it('shows the empty state when no building model is provided', () => {
      const wrapper = mount(RoomsSelector, {
  ...
  describe('edit modal and saving', () => {
    it('opens the EditRoomModal modal with the correct room payload when a card triggers edit', async () => {
