...
describe('status helper', () => {
  ...
  describe('getStatusColor', () => {
    ...
    it('returns emerald color for empty status', () => {
      expect(getStatusColor('dashboard.table.rooms.status.empty')).toBe('text-emerald-600 font-semibold')
    })
    ...
    it('returns red color for full status', () => {
      expect(getStatusColor('dashboard.table.rooms.status.full')).toBe('text-red-600 font-semibold')
    })

    it('returns red color for default/overcrowded status', () => {
      expect(getStatusColor('dashboard.table.rooms.status.overcrowded')).toBe('text-red-600 font-semibold')
